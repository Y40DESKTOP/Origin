...
package/%.xdc.inc package/%_shareregion.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package shareregion" (because $@ is older than $(firstword $?))" ...
...
package/rel/undefinedshareregionpackage/package.rel.xml: package/package.cfg.xdc.inc
package/package.cfg.xdc.inc: $(XDCROOT)/packages/xdc/cfg/cfginc.js package.xdc
	@$(MSG) generating schema include file list ...
	$(CONFIG) -f $(XDCROOT)/packages/xdc/cfg/cfginc.js shareregion $@
...
.PHONY: release,shareregion
shareregion.zip: package/package.bld.xml
shareregion.zip: package/build.cfg
shareregion.zip: package/package.xdc.inc
shareregion.zip: package/package.cfg.xdc.inc
ifeq (,$(MK_NOGENDEPS))
-include package/rel/shareregion.zip.dep
endif
package/rel/shareregion/shareregion/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

shareregion.zip: package/rel/shareregion.xdc.inc package/rel/shareregion/shareregion/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELZIP,package/rel/shareregion.xdc.inc,package/rel/shareregion.zip.dep)


release release,shareregion: all shareregion.zip
clean:: .clean
	-$(RM) shareregion.zip
	-$(RM) package/rel/shareregion.xdc.inc
	-$(RM) package/rel/shareregion.zip.dep
